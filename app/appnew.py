...
from sqlalchemy import form

# app.py with Flask CLI
...
class TimeEntry(db.Model):
    ...
    id= db.Columndb.Integer,_key=True
    start_time = dbColumn(db.DateTime, nullable=False, default=datetime.utcnow)
    end_time = db.Column(db.DateTime)
